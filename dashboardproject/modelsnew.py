...
class BluedartAwbNumbers(models.Model):
    awb_number = models.CharField(max_length=100)
    courier_keyword = models.CharField(max_length=16, blank=True, null=True)
    awb_type = models.CharField(max_length=7, blank=True, null=True)
...
class BluedartNseAwbNumbers(models.Model):
    awb_number = models.CharField(max_length=100)
    courier_keyword = models.CharField(max_length=16, blank=True, null=True)
    awb_type = models.CharField(max_length=7, blank=True, null=True)
    used = models.CharField(max_length=1)
    ...
    class Meta:
        managed = False
        db_table = 'bluedart_nse_awb_numbers'


class BluedartWebhookRecord(models.Model):
    awb_number = models.CharField(max_length=50, blank=True, null=True)
    request = models.TextField(blank=True, null=True)
    is_sync = models.IntegerField()
    inserted = models.DateTimeField(blank=True, null=True)
    error = models.TextField(blank=True, null=True)
    is_alpha = models.CharField(max_length=3)

    class Meta:
        managed = False
        db_table = 'bluedart_webhook_record'
...
class BulkCancelOrdersJob(models.Model):
    seller_id = models.IntegerField(blank=True, null=True)
    ...
    is_notified = models.CharField(max_length=1, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'bulk_cancel_orders_job'


class BulkNdrActionFile(models.Model):
    seller_id = models.IntegerField(blank=True, null=True)
    created = models.DateTimeField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'bulk_ndr_action_file'


class BulkShipOrdersJob(models.Model):
    seller_id = models.IntegerField(blank=True, null=True)
    orders = models.TextField(blank=True, null=True)
    created = models.DateTimeField(blank=True, null=True)
    total = models.IntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'bulk_ship_orders_job'


class BulkShipOrdersJobDetails(models.Model):
    job_id = models.IntegerField()
    order_id = models.IntegerField()
    is_deleted = models.CharField(max_length=1)
    is_shipped = models.CharField(max_length=1)

    class Meta:
        managed = False
        db_table = 'bulk_ship_orders_job_details'


class ChannelOrderStatusList(models.Model):
    channel = models.IntegerField(blank=True, null=True)
    channel_id = models.IntegerField(blank=True, null=True)
    pickup_scheduled = models.CharField(max_length=25, blank=True, null=True)
    picked_up = models.CharField(max_length=25, blank=True, null=True)
    in_transit = models.CharField(max_length=25, blank=True, null=True)
    out_for_delivery = models.CharField(max_length=25, blank=True, null=True)
    delivered = models.CharField(max_length=25, blank=True, null=True)
    inserted = models.DateTimeField(blank=True, null=True)
    modified = models.DateTimeField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'channel_order_status_list'
...
class CodToPrepaidHistory(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'cod_to_prepaid_history'
...
class Configuration(models.Model):
    ...
    qc_charges = models.IntegerField(blank=True, null=True)
    bulkship_limit = models.IntegerField(blank=True, null=True)
    mis_download_limit = models.IntegerField(blank=True, null=True)
...
class CourierMissStatusCode(models.Model):
    order_id = models.IntegerField(blank=True, null=True)
    courier_keyword = models.CharField(max_length=100, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'courier_miss_status_code'
...
class CustomSellerChannels(models.Model):
    seller_id = models.IntegerField(blank=True, null=True)
    courier_partner = models.CharField(max_length=30, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'custom_seller_channels'


class CustomXbeesAwbNumbers(models.Model):
    seller_id = models.IntegerField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'custom_xbees_awb_numbers'
...
class DashboardappChildsidebar(models.Model):
    id = models.BigAutoField(primary_key=True)
    c_name = models.CharField(max_length=100, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'dashboardapp_childsidebar'


class DashboardappParentsidebar(models.Model):
    id = models.BigAutoField(primary_key=True)
    p_name = models.CharField(max_length=100, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'dashboardapp_parentsidebar'


class DashboardappShipmenttype(models.Model):
    id = models.BigAutoField(primary_key=True)
    shipment_name = models.CharField(max_length=100, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'dashboardapp_shipmenttype'
...
class DtdcLlAwbNumbers(models.Model):
...
class DtdcSeAwbNumbers(models.Model):
    awb_number = models.CharField(max_length=20)
    used = models.CharField(max_length=1, blank=True, null=True)
    used_time = models.DateTimeField(blank=True, null=True)
    used_by = models.IntegerField(blank=True, null=True)
...
class InternationalOrders(models.Model):
    ...
    qc_help_description = models.TextField(blank=True, null=True)
    qc_label = models.CharField(max_length=100, blank=True, null=True)
    qc_value_to_check = models.CharField(max_length=100, blank=True, null=True)
    qc_image = models.TextField(blank=True, null=True)
    business_type = models.CharField(max_length=80, blank=True, null=True)
    selling_mode = models.CharField(max_length=80, blank=True, null=True)
    business_category = models.CharField(max_length=80, blank=True, null=True)
    international_volume = models.CharField(max_length=80, blank=True, null=True)
    order_volume = models.CharField(max_length=80, blank=True, null=True)
    selling_internationally = models.IntegerField()
    entry_type = models.CharField(max_length=13, blank=True, null=True)
    ofd_date = models.DateTimeField(blank=True, null=True)
    shopify_tag = models.CharField(max_length=200, blank=True, null=True)
    invoice_number = models.CharField(max_length=40, blank=True, null=True)
    cancel_source = models.CharField(max_length=3)
    cancel_datetime = models.DateTimeField(blank=True, null=True)
    cancel_ip = models.CharField(max_length=30, blank=True, null=True)
...
class LabelCustomizations(models.Model):
    ...
    footer_customize_value = models.CharField(max_length=200, blank=True, null=True)
    custom_footer_enable = models.CharField(max_length=10, blank=True, null=True)
    display_full_product_name = models.CharField(max_length=1, blank=True, null=True)
    other_charges = models.CharField(max_length=1)
    contact_mask = models.CharField(max_length=10, blank=True, null=True)
    ordernumber_visibility = models.CharField(max_length=10, blank=True, null=True)
    barcode_visibility = models.CharField(max_length=10, blank=True, null=True)
    disclaimer_text = models.CharField(max_length=1, blank=True, null=True)
    all_product_display = models.CharField(max_length=1)
    tabular_form_enabled = models.CharField(max_length=1, blank=True, null=True)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
    s_gst_mask = models.CharField(max_length=1)
    s_contact_mask = models.CharField(max_length=1)
...
class ManifestationIssues(models.Model):
    order_id = models.IntegerField()
...
class OrderWhatsappMessageLogs(models.Model):
    order_id = models.IntegerField(blank=True, null=True)
    seller_id = models.IntegerField(blank=True, null=True)
    awb_number = models.CharField(max_length=40, blank=True, null=True)
    order_status = models.CharField(max_length=20, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'order_whatsapp_message_logs'
...
class Orders(models.Model):
    ...
    delivery_address = models.TextField(blank=True, null=True)
    status = models.CharField(max_length=50)
    delivery_stutus = models.IntegerField(blank=True, null=True)
    ...
    channel_id = models.CharField(max_length=100, db_collation='utf8_general_ci', blank=True, null=True)
    ...
    channel_code = models.CharField(max_length=100, blank=True, null=True)
    channel_name = models.CharField(max_length=100, blank=True, null=True)
    is_alpha = models.CharField(max_length=3, db_collation='utf8_general_ci')
    is_retry = models.IntegerField()
    is_custom = models.IntegerField()
    other_charges = models.FloatField()
    collectable_amount = models.DecimalField(max_digits=16, decimal_places=2)
    is_qc = models.CharField(max_length=1)
...
class Partners(models.Model):
    ...
    qc_enabled = models.CharField(max_length=1)
...
class ProfessionalAwbNumbers(models.Model):
    awb_number = models.CharField(max_length=20, blank=True, null=True)
    used = models.CharField(max_length=1, blank=True, null=True)
    used_time = models.DateTimeField(blank=True, null=True)
    used_by = models.IntegerField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'professional_awb_numbers'


class RateCardRequest(models.Model):
    seller_id = models.IntegerField(blank=True, null=True)
...
class RatesCardRequestData(models.Model):
    plan_id = models.IntegerField(blank=True, null=True)
    seller_id = models.IntegerField(blank=True, null=True)
    partner_id = models.IntegerField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'rates_card_request_data'


class ReassignOrderDetails(models.Model):
    order_id = models.IntegerField(blank=True, null=True)
    old_awb_number = models.CharField(max_length=60, blank=True, null=True)
    new_awb_number = models.CharField(max_length=60, blank=True, null=True)
    courier_partner = models.CharField(max_length=60, blank=True, null=True)
    seller_id = models.IntegerField(blank=True, null=True)
    inserted = models.DateTimeField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'reassign_order_details'
...
class Rules(models.Model):
    ...
    match_value = models.TextField(db_collation='utf8_general_ci')
...
class SellerCodRemitRechargeHistory(models.Model):
    seller_id = models.IntegerField(blank=True, null=True)
    order_ids = models.TextField(blank=True, null=True)
    awb_numbers = models.TextField(blank=True, null=True)
    request_recharge = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    actual_recharge = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    datetime = models.DateTimeField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'seller_cod_remit_recharge_history'


class SellerCodRemittance(models.Model):
    order_id = models.IntegerField(blank=True, null=True)
    seller_id = models.IntegerField(blank=True, null=True)
    customer_order_number = models.CharField(max_length=255, blank=True, null=True)
    awb_number = models.CharField(max_length=255, blank=True, null=True)
    ...
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
    seller_code = models.CharField(max_length=100, blank=True, null=True)
    seller_name = models.CharField(max_length=300, blank=True, null=True)
    deduction_amount = models.DecimalField(max_digits=10, decimal_places=0, blank=True, null=True)
    remark = models.CharField(max_length=400, blank=True, null=True)
    additional_remark = models.CharField(max_length=400, blank=True, null=True)
    invoice_amount = models.FloatField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'seller_cod_remittance'


class SellerCodRemittanceLog(models.Model):
    job_id = models.IntegerField()
    order_id = models.IntegerField(blank=True, null=True)
    seller_id = models.IntegerField(blank=True, null=True)
    customer_order_number = models.CharField(max_length=255, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'seller_cod_remittance_log'
...
class SellerRateChangeDetails(models.Model):
    seller_rate_change = models.ForeignKey('SellerRateChanges', models.DO_NOTHING)
    plan_id = models.IntegerField(blank=True, null=True)
    seller_id = models.IntegerField(blank=True, null=True)
    partner_id = models.IntegerField(blank=True, null=True)
    within_city = models.FloatField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'seller_rate_change_details'


class SellerRateChanges(models.Model):
    seller_id = models.IntegerField(blank=True, null=True)
    modified = models.DateTimeField()
    modified_ip = models.CharField(max_length=50)

    class Meta:
        managed = False
        db_table = 'seller_rate_changes'
...
class Sellers(models.Model):
    ...
    whatsapp_charges = models.FloatField()
    ...
    rto_charge = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    ...
    reverse_charge = models.FloatField(blank=True, null=True)
    ...
    onboarded_via = models.CharField(max_length=3)
    cheapest_enabled = models.CharField(max_length=1, blank=True, null=True)
    sku_weight_upload = models.CharField(max_length=1)
    remittance_frequency = models.IntegerField()
    remittanceweekday = models.CharField(db_column='remittanceWeekDay', max_length=250)  # Field name made lowercase.
    product_name_as_sku = models.CharField(max_length=1)
    duplicate_order_number_flag = models.CharField(max_length=1)
    whatsapp_service = models.IntegerField()
    floating_value_flag = models.CharField(max_length=1)
    auto_reassign_enabled = models.CharField(max_length=1)
    default_invoice_amount = models.IntegerField(blank=True, null=True)
    auto_cancellation_flag = models.IntegerField()
...
class SendManifestationSmsJob(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'send_manifestation_sms_job'


class SendManifestationWhatsappJob(models.Model):
    order_count = models.IntegerField()
    order_ids = models.TextField()
    start_time = models.DateTimeField(blank=True, null=True)
    status = models.CharField(max_length=10, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'send_manifestation_whatsapp_job'
...
class ServiceablePincode(models.Model):
    ...
    is_cod = models.CharField(max_length=1)
    status = models.CharField(max_length=1, blank=True, null=True)
    inserted = models.DateTimeField(blank=True, null=True)
    active = models.CharField(max_length=1)
    modified = models.DateTimeField(blank=True, null=True)
    remark = models.TextField(blank=True, null=True)
    cluster_code = models.CharField(max_length=60, blank=True, null=True)
...
class ServiceablePincodeFm(models.Model):
    ...
    city = models.CharField(max_length=50, blank=True, null=True)
    state = models.CharField(max_length=50, blank=True, null=True)
    origin_code = models.CharField(max_length=6, blank=True, null=True)
    branch_code = models.CharField(max_length=50, blank=True, null=True)
    status = models.CharField(max_length=1, blank=True, null=True)
    inserted = models.DateTimeField(blank=True, null=True)
...
class ShipmentHoldHistory(models.Model):
    employee_id = models.IntegerField(blank=True, null=True)
    awb_number = models.CharField(max_length=70, blank=True, null=True)
    seller_id = models.IntegerField(blank=True, null=True)
    created_at = models.DateTimeField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'shipment_hold_history'
...
class Slider(models.Model):
    ...
    detail = models.TextField(db_collation='utf8_general_ci', blank=True, null=True)
    image = models.TextField(blank=True, null=True)
    status = models.CharField(max_length=1)
    inserted = models.DateTimeField(blank=True, null=True)
    inserted_by = models.IntegerField(blank=True, null=True)
...
class WebBlog(models.Model):
    ...
    from_url = models.CharField(max_length=1000, blank=True, null=True)
    date = models.DateField(blank=True, null=True)
    status = models.CharField(max_length=10, blank=True, null=True)
...
class WebFooterConfig(models.Model):
    ...
    whatsapp_image = models.TextField(blank=True, null=True)
    footer_image = models.TextField(blank=True, null=True)
...
class ZzQueryExecutionLogs(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'zz_query_execution_logs'
